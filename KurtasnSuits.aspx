<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="KurtasnSuits.aspx.cs" Inherits="KurtasnSuits" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Kurta & Suits</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <br />
  ...
  <h2 style="color:#EC7FA9;">Kurta & Suits</h2>  
         <hr class="BORDER" />
