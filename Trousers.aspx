<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Trousers.aspx.cs" Inherits="Trousers" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Trouser's</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <h2 style="color:#EC7FA9;">Trouser's</h2>  
         <hr class="BORDER"/>
