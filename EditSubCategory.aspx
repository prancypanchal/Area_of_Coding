<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true" CodeFile="EditSubCategory.aspx.cs" Inherits="EdirSubCategory" %>
...
<%--<div class="well-sm"><h3 class="alert-danger text-center">Edit Sub Category</h3></div>--%>
    <div class="row">
        ...
        <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center" style="color:#EC7FA9; background-color:#FFEDFA;"> All Category</h4>
                <br />
