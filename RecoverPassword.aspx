            ...
            <div class ="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <br /><asp:CompareValidator ID="CompareValidatorPass" runat="server" ErrorMessage="Confirm password not match...try again!" ControlToCompare="txtNewPass" ControlToValidate="txtConfirmpassword" ForeColor="Red"></asp:CompareValidator>
                    </div>
                </div>
